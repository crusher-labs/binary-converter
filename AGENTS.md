...
Single-purpose static tool, built as a **world page**: front panel. Convert text to binary and binary back to text on a computer front panel in the Altair / IMSAI tradition: every character lights a row of eight lamps you can flip, an address row of switches reads any number out in decimal, hex, octal and binary, and status lamps report errors, overflow and UTF-8. Nothing uploaded. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://crusher-labs.github.io/binary-converter/
